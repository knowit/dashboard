...
var _knowit$dashboard$DateFormatting$norwegianLabelForMonth = function (month) {
	var _p0 = month;
	switch (_p0.ctor) {
		case 'Jan':
			return 'januar';
...
var _knowit$dashboard$DateFormatting$norwegianLabelForDay = function (day) {
	var _p1 = day;
	switch (_p1.ctor) {
		case 'Mon':
			return 'mandag';
...
var _knowit$dashboard$DateFormatting$viewTime = function (time) {
	var asDate = _elm_lang$core$Date$fromTime(time);
	var date = A2(
		_elm_lang$core$Basics_ops['++'],
		_knowit$dashboard$DateFormatting$norwegianLabelForDay(
			_elm_lang$core$Date$dayOfWeek(asDate)),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Date$day(asDate)),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'. ',
					_knowit$dashboard$DateFormatting$norwegianLabelForMonth(
						_elm_lang$core$Date$month(asDate))))));
	var clock = A2(_mgold$elm_date_format$Time_Format$format, '%H:%M', time);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		date,
		A2(_elm_lang$core$Basics_ops['++'], ' ', clock));
};
...
var _knowit$dashboard$Clock$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {
			ctor: '_Tuple2',
...
var _knowit$dashboard$Clock$initModel = _elm_lang$core$Maybe$Nothing;
var _knowit$dashboard$Clock$TimeLabel = {ctor: 'TimeLabel'};
var _knowit$dashboard$Clock$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_knowit$dashboard$Clock$TimeLabel,
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Style_Font$size(50),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _knowit$dashboard$Clock$view = function (model) {
	return A2(
		_mdgriffith$style_elements$Element$layout,
		_knowit$dashboard$Clock$stylesheet,
		function (t) {
			return A3(
				...
				A2(
					...
					function (_p1) {
						return _elm_lang$core$String$toUpper(
							_knowit$dashboard$DateFormatting$viewTime(_p1));
					},
					model))));
};
var _knowit$dashboard$Clock$UpdateNow = function (a) {
	return {ctor: 'UpdateNow', _0: a};
};
var _knowit$dashboard$Clock$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _knowit$dashboard$Clock$UpdateNow);
};
var _knowit$dashboard$Clock$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _elm_lang$core$Platform_Cmd$none},
		view: _knowit$dashboard$Clock$view,
		update: _knowit$dashboard$Clock$update,
		subscriptions: _knowit$dashboard$Clock$subscriptions
	})();

var _knowit$dashboard$Kantinemeny$initModel = _elm_lang$core$Maybe$Nothing;
var _knowit$dashboard$Kantinemeny$MenuItem = F2(
	function (a, b) {
		return {name: a, price: b};
	});
var _knowit$dashboard$Kantinemeny$menuDecoder = _elm_lang$core$Json_Decode$list(
	A3(
		_elm_lang$core$Json_Decode$map2,
		_knowit$dashboard$Kantinemeny$MenuItem,
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'price', _elm_lang$core$Json_Decode$string)));
var _knowit$dashboard$Kantinemeny$NoStyle = {ctor: 'NoStyle'};
var _knowit$dashboard$Kantinemeny$viewMenuItem = function (menuItem) {
	return A3(
		_mdgriffith$style_elements$Element$el,
		_knowit$dashboard$Kantinemeny$NoStyle,
		{
			ctor: '::',
		...
		_mdgriffith$style_elements$Element$text(
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					' (',
					A2(_elm_lang$core$Basics_ops['++'], menuItem.price, ')')))));
};
var _knowit$dashboard$Kantinemeny$Header = {ctor: 'Header'};
var _knowit$dashboard$Kantinemeny$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_knowit$dashboard$Kantinemeny$Header,
			{
				ctor: '::',
...
var _knowit$dashboard$Kantinemeny$view = function (model) {
	return A2(
		_mdgriffith$style_elements$Element$layout,
		_knowit$dashboard$Kantinemeny$stylesheet,
		function () {
			var _p0 = model;
			if (_p0.ctor === 'Just') {
				return A3(
					...
					},
					{
						...
						_0: A3(
							...
							_knowit$dashboard$Kantinemeny$Header,
							{ctor: '[]'},
							_mdgriffith$style_elements$Element$text('Dagens kantinemeny')),
						_1: {
							ctor: '::',
							_0: A3(
								_mdgriffith$style_elements$Element$column,
								...
								A2(_elm_lang$core$List$map, _knowit$dashboard$Kantinemeny$viewMenuItem, _p0._0)),
							_1: {ctor: '[]'}
						}
					});
			} else {
...
var _knowit$dashboard$Kantinemeny$MenuResult = function (a) {
	return {ctor: 'MenuResult', _0: a};
};
var _knowit$dashboard$Kantinemeny$getMenu = A2(
	_elm_lang$http$Http$send,
	_knowit$dashboard$Kantinemeny$MenuResult,
	A2(_elm_lang$http$Http$get, 'https://us-central1-knowit-cloud-9b7de.cloudfunctions.net/getMenuForDay', _knowit$dashboard$Kantinemeny$menuDecoder));
var _knowit$dashboard$Kantinemeny$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'GetMenu') {
			return {ctor: '_Tuple2', _0: model, _1: _knowit$dashboard$Kantinemeny$getMenu};
		} else {
			if (_p1._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Maybe$Just(_p1._0._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
...
var _knowit$dashboard$Kantinemeny$GetMenu = function (a) {
	return {ctor: 'GetMenu', _0: a};
};
var _knowit$dashboard$Kantinemeny$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$minute, _knowit$dashboard$Kantinemeny$GetMenu);
};
var _knowit$dashboard$Kantinemeny$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _knowit$dashboard$Kantinemeny$getMenu},
		view: _knowit$dashboard$Kantinemeny$view,
		update: _knowit$dashboard$Kantinemeny$update,
		subscriptions: _knowit$dashboard$Kantinemeny$subscriptions
	})();

var _knowit$dashboard$MeetingRooms$floorToString = function (floor) {
	var _p0 = floor;
	if (_p0.ctor === 'Sundt4th') {
		return '4. etasje';
	} else {
		return '5. etasje';
	}
};
var _knowit$dashboard$MeetingRooms$viewRoomAvailability = function (room) {
	var availabilityDesc = room.isBusy ? A2(
		_elm_lang$core$Basics_ops['++'],
		'Opptatt til ',
		A2(
			_elm_lang$core$Maybe$withDefault,
			...
			A2(
				...
				function (d) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						_knowit$dashboard$DateFormatting$viewTime(
							_elm_lang$core$Date$toTime(d)),
						'.');
				},
				room.currentEventEnd))) : A2(
		_elm_lang$core$Basics_ops['++'],
		'Ledig',
		A2(
			_elm_lang$core$Maybe$withDefault,
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							room.roomName,
							A2(_elm_lang$core$Basics_ops['++'], ': ', availabilityDesc))))),
			_1: {ctor: '[]'}
		});
};
var _knowit$dashboard$MeetingRooms$view = function (model) {
	var _p1 = model.rooms;
	if (_p1.ctor === 'Just') {
		var _p2 = A2(
			_elm_lang$core$List$partition,
			...
			A2(
				...
				_p1._0));
		var busyRooms = _p2._0;
		var freeRooms = _p2._1;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Ledige rom'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						A2(_elm_lang$core$List$map, _knowit$dashboard$MeetingRooms$viewRoomAvailability, freeRooms)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$h3,
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Opptatte rom'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$ul,
								{ctor: '[]'},
								A2(_elm_lang$core$List$map, _knowit$dashboard$MeetingRooms$viewRoomAvailability, busyRooms)),
							_1: {
								ctor: '::',
								_0: function () {
									var _p3 = model.error;
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Møteromstatus'),
				_1: {ctor: '[]'}
			});
	}
};
var _knowit$dashboard$MeetingRooms$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _knowit$dashboard$MeetingRooms$initModel = {rooms: _elm_lang$core$Maybe$Nothing, error: _elm_lang$core$Maybe$Nothing};
var _knowit$dashboard$MeetingRooms$Model = F2(
	function (a, b) {
		return {rooms: a, error: b};
	});
var _knowit$dashboard$MeetingRooms$MeetingRoom = F4(
	function (a, b, c, d) {
		return {floor: a, number: b, name: c, calendarEmail: d};
	});
var _knowit$dashboard$MeetingRooms$RoomAvailability = F5(
	function (a, b, c, d, e) {
		return {roomCode: a, roomName: b, isBusy: c, currentEventEnd: d, nextEventStart: e};
	});
var _knowit$dashboard$MeetingRooms$Refresh = function (a) {
	return {ctor: 'Refresh', _0: a};
};
var _knowit$dashboard$MeetingRooms$RoomsAvailabilityResponse = function (a) {
	return {ctor: 'RoomsAvailabilityResponse', _0: a};
};
var _knowit$dashboard$MeetingRooms$getRoomsAvailability = function () {
	...
	var decodeRoom = A3(
		...
		'nextEventStart',
		_elm_lang$core$Json_Decode$nullable(decodeDate),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'currentEventEnd',
			_elm_lang$core$Json_Decode$nullable(decodeDate),
			A3(
				...
				A3(
					...
					A3(
						...
						'roomCode',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_knowit$dashboard$MeetingRooms$RoomAvailability))))));
	var url = 'http://10.205.0.5:4422/rooms';
	return A2(
		_elm_lang$http$Http$send,
		_knowit$dashboard$MeetingRooms$RoomsAvailabilityResponse,
		A2(
			_elm_lang$http$Http$get,
			url,
			_elm_lang$core$Json_Decode$list(decodeRoom)));
}();
var _knowit$dashboard$MeetingRooms$update = F2(
	function (msg, model) {
		var _p5 = msg;
		if (_p5.ctor === 'RoomsAvailabilityResponse') {
			if (_p5._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							rooms: _elm_lang$core$Maybe$Just(_p5._0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
			...
			return {ctor: '_Tuple2', _0: model, _1: _knowit$dashboard$MeetingRooms$getRoomsAvailability};
		}
	});
var _knowit$dashboard$MeetingRooms$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _knowit$dashboard$MeetingRooms$initModel, _1: _knowit$dashboard$MeetingRooms$getRoomsAvailability},
		view: _knowit$dashboard$MeetingRooms$view,
		update: _knowit$dashboard$MeetingRooms$update,
		subscriptions: _knowit$dashboard$MeetingRooms$subscriptions
	})();
var _knowit$dashboard$MeetingRooms$Sundt5th = {ctor: 'Sundt5th'};
var _knowit$dashboard$MeetingRooms$Sundt4th = {ctor: 'Sundt4th'};

var _knowit$dashboard$RuterMonitor$formatTimedelta = function (timeDelta) {
	var hours = _elm_lang$core$Basics$floor(
		_elm_lang$core$Time$inHours(timeDelta));
	var afterHours = timeDelta - (_elm_lang$core$Basics$toFloat(hours) * _elm_lang$core$Time$hour);
	var minutes = _elm_lang$core$Basics$floor(
		_elm_lang$core$Time$inMinutes(afterHours));
	var afterMinutes = afterHours - (_elm_lang$core$Basics$toFloat(minutes) * _elm_lang$core$Time$minute);
	var seconds = _elm_lang$core$Basics$floor(
		_elm_lang$core$Time$inSeconds(afterMinutes));
	return (_elm_lang$core$Native_Utils.cmp(hours, 0) > 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
...
var _knowit$dashboard$RuterMonitor$withTimeDelta = F2(
	function (time, departure) {
		return {
			departure: departure,
			timeDelta: _elm_lang$core$Date$toTime(departure.expectedArrivalTime) - time
		};
	});
var _knowit$dashboard$RuterMonitor$hideDeparturesInThePast = _elm_lang$core$List$filter(
	function (t) {
		return _elm_lang$core$Native_Utils.cmp(t.timeDelta, _elm_lang$core$Time$minute) > 0;
	});
var _knowit$dashboard$RuterMonitor$initModel = {now: _elm_lang$core$Maybe$Nothing, departures: _eeue56$elm_all_dict$EveryDict$empty, errorMessage: _elm_lang$core$Maybe$Nothing};
var _knowit$dashboard$RuterMonitor$Model = F3(
	function (a, b, c) {
		return {now: a, departures: b, errorMessage: c};
	});
var _knowit$dashboard$RuterMonitor$DepartureWithTimeDelta = F2(
	function (a, b) {
		return {departure: a, timeDelta: b};
	});
var _knowit$dashboard$RuterMonitor$Departure = F4(
	function (a, b, c, d) {
		return {destinationName: a, expectedArrivalTime: b, lineRef: c, lineColour: d};
	});
var _knowit$dashboard$RuterMonitor$DepartureHeading = {ctor: 'DepartureHeading'};
var _knowit$dashboard$RuterMonitor$NoStyle = {ctor: 'NoStyle'};
var _knowit$dashboard$RuterMonitor$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_knowit$dashboard$RuterMonitor$NoStyle,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$style_elements$Style$style,
				_knowit$dashboard$RuterMonitor$DepartureHeading,
				{
					ctor: '::',
					_0: _mdgriffith$style_elements$Style_Font$size(40),
					_1: {ctor: '[]'}
...
var _knowit$dashboard$RuterMonitor$viewDeparture = function (departureWithTimeDelta) {
	var col = function (content) {
		return A3(
			_mdgriffith$style_elements$Element$column,
			_knowit$dashboard$RuterMonitor$NoStyle,
			{
			...
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text(content),
				_1: {ctor: '[]'}
			});
	};
	var departure = departureWithTimeDelta.departure;
	var transportTypeSymbol = function () {
		var _p0 = departure.lineColour;
		switch (_p0) {
			case 'E60000':
				return '🚌';
			case '0B91EF':
	...
	return A3(
		...
		{
			ctor: '::',
			_0: col(transportTypeSymbol),
			_1: {
				ctor: '::',
				_0: col(departure.lineRef),
				_1: {
					ctor: '::',
					_0: col(departure.destinationName),
					_1: {
						ctor: '::',
						_0: col(
							_knowit$dashboard$RuterMonitor$formatTimedelta(departureWithTimeDelta.timeDelta)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _knowit$dashboard$RuterMonitor$viewDepartures = F3(
	function (stop, departures, now) {
		var stopLabel = function () {
			var _p1 = stop;
			if (_p1.ctor === 'Heimdalsgata') {
				return 'Heimdalsgata';
			} else {
				return 'Grønland t-bane';
			}
		}();
		return function (t) {
			return A3(
				...
				},
				{
					...
					_0: A3(
						...
						_knowit$dashboard$RuterMonitor$DepartureHeading,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text(stopLabel)),
					_1: {
						ctor: '::',
						_0: t,
						_1: {ctor: '[]'}
			...
			A3(
				...
				_elm_lang$core$List$singleton(
					A2(
						_elm_lang$core$List$map,
						_knowit$dashboard$RuterMonitor$viewDeparture,
						A2(
							...
							A2(
								...
								_knowit$dashboard$RuterMonitor$hideDeparturesInThePast(
									A2(
										_elm_lang$core$List$map,
										_knowit$dashboard$RuterMonitor$withTimeDelta(now),
										departures))))))));
	});
var _knowit$dashboard$RuterMonitor$view = function (model) {
	return A2(
		_mdgriffith$style_elements$Element$layout,
		_knowit$dashboard$RuterMonitor$stylesheet,
		function () {
				...
				return A3(
					...
					{ctor: '[]'},
					{
						...
						_0: A3(
							...
							_knowit$dashboard$RuterMonitor$NoStyle,
							{ctor: '[]'},
							_mdgriffith$style_elements$Element$text('Error')),
						_1: {
							ctor: '::',
							_0: A3(
								_mdgriffith$style_elements$Element$el,
								_knowit$dashboard$RuterMonitor$NoStyle,
								{ctor: '[]'},
								_mdgriffith$style_elements$Element$text('Something went wrong:')),
							_1: {
								ctor: '::',
								_0: A3(
									_mdgriffith$style_elements$Element$el,
									_knowit$dashboard$RuterMonitor$NoStyle,
									{ctor: '[]'},
									_mdgriffith$style_elements$Element$text(_p2._0)),
								_1: {ctor: '[]'}
							}
						}
					});
				...
				if (_p3.ctor === 'Just') {
					return A3(
						...
						A2(
							...
							function (_p4) {
								var _p5 = _p4;
								return A3(_knowit$dashboard$RuterMonitor$viewDepartures, _p5._0, _p5._1, _p3._0);
							},
							_eeue56$elm_all_dict$EveryDict$toList(model.departures)));
				} else {
					return _mdgriffith$style_elements$Element$empty;
				}
			}
...
var _knowit$dashboard$RuterMonitor$Gronland = {ctor: 'Gronland'};
var _knowit$dashboard$RuterMonitor$Heimdalsgata = {ctor: 'Heimdalsgata'};
var _knowit$dashboard$RuterMonitor$UpdateNow = function (a) {
	return {ctor: 'UpdateNow', _0: a};
};
var _knowit$dashboard$RuterMonitor$RefreshDepartures = function (a) {
	return {ctor: 'RefreshDepartures', _0: a};
};
var _knowit$dashboard$RuterMonitor$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, 10 * _elm_lang$core$Time$second, _knowit$dashboard$RuterMonitor$RefreshDepartures),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _knowit$dashboard$RuterMonitor$UpdateNow),
				_1: {ctor: '[]'}
			}
		});
};
var _knowit$dashboard$RuterMonitor$DeparturesResponse = F2(
	function (a, b) {
		return {ctor: 'DeparturesResponse', _0: a, _1: b};
	});
var _knowit$dashboard$RuterMonitor$getDeparturesForStop = function (stop) {
	var date = function () {
		var convert = function (raw) {
			var _p6 = _elm_lang$core$Date$fromString(raw);
			if (_p6.ctor === 'Ok') {
		...
		A3(
			...
			A3(
				...
				A3(
					...
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_knowit$dashboard$RuterMonitor$Departure)))));
	var stopId = function (stop) {
		var _p7 = stop;
		if (_p7.ctor === 'Heimdalsgata') {
			return '3010531';
		} else {
			return '3010610';
		}
	...
	return A2(
		_elm_lang$http$Http$send,
		_knowit$dashboard$RuterMonitor$DeparturesResponse(stop),
		A2(
			_elm_lang$http$Http$get,
			url,
			_elm_lang$core$Json_Decode$list(decodeDeparture)));
};
var _knowit$dashboard$RuterMonitor$getAllDepartures = _elm_lang$core$Platform_Cmd$batch(
	A2(
		_elm_lang$core$List$map,
		_knowit$dashboard$RuterMonitor$getDeparturesForStop,
		{
			ctor: '::',
			_0: _knowit$dashboard$RuterMonitor$Heimdalsgata,
			_1: {
				ctor: '::',
				_0: _knowit$dashboard$RuterMonitor$Gronland,
				_1: {ctor: '[]'}
			}
		}));
var _knowit$dashboard$RuterMonitor$update = F2(
	function (msg, model) {
		var _p8 = msg;
		switch (_p8.ctor) {
			case 'DeparturesResponse':
				if (_p8._1.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								departures: A3(_eeue56$elm_all_dict$EveryDict$insert, _p8._0, _p8._1._0, model.departures),
			...
			case 'RefreshDepartures':
				return {ctor: '_Tuple2', _0: model, _1: _knowit$dashboard$RuterMonitor$getAllDepartures};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _knowit$dashboard$RuterMonitor$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _knowit$dashboard$RuterMonitor$initModel, _1: _knowit$dashboard$RuterMonitor$getAllDepartures},
		view: _knowit$dashboard$RuterMonitor$view,
		update: _knowit$dashboard$RuterMonitor$update,
		subscriptions: _knowit$dashboard$RuterMonitor$subscriptions
	})();
...
var _knowit$dashboard$Main$wrap = F3(
	function (toModelFunction, subType, _p0) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple2',
			_0: toModelFunction(_p1._0),
			_1: A2(_elm_lang$core$Platform_Cmd$map, subType, _p1._1)
		};
	});
var _knowit$dashboard$Main$initModel = {clock: _knowit$dashboard$Clock$initModel, ruterMonitor: _knowit$dashboard$RuterMonitor$initModel, kantinemeny: _knowit$dashboard$Kantinemeny$initModel, meetingRooms: _knowit$dashboard$MeetingRooms$initModel};
var _knowit$dashboard$Main$Model = F4(
	function (a, b, c, d) {
		return {clock: a, ruterMonitor: b, kantinemeny: c, meetingRooms: d};
	});
var _knowit$dashboard$Main$CellStyle = {ctor: 'CellStyle'};
var _knowit$dashboard$Main$GridStyle = {ctor: 'GridStyle'};
var _knowit$dashboard$Main$NoStyle = {ctor: 'NoStyle'};
var _knowit$dashboard$Main$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_knowit$dashboard$Main$NoStyle,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$style_elements$Style$style,
				_knowit$dashboard$Main$GridStyle,
				{ctor: '[]'}),
			_1: {
				ctor: '::',
				_0: A2(
					_mdgriffith$style_elements$Style$style,
					_knowit$dashboard$Main$CellStyle,
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Style_Color$background(
							A3(_elm_lang$core$Color$rgb, 208, 207, 205)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _knowit$dashboard$Main$MeetingRoomsMsg = function (a) {
	return {ctor: 'MeetingRoomsMsg', _0: a};
};
var _knowit$dashboard$Main$KantinemenyMsg = function (a) {
	return {ctor: 'KantinemenyMsg', _0: a};
};
var _knowit$dashboard$Main$RuterMonitorMsg = function (a) {
	return {ctor: 'RuterMonitorMsg', _0: a};
};
var _knowit$dashboard$Main$initialCmd = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: A2(_elm_lang$core$Platform_Cmd$map, _knowit$dashboard$Main$RuterMonitorMsg, _knowit$dashboard$RuterMonitor$getAllDepartures),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _knowit$dashboard$Main$KantinemenyMsg, _knowit$dashboard$Kantinemeny$getMenu),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _knowit$dashboard$Main$MeetingRoomsMsg, _knowit$dashboard$MeetingRooms$getRoomsAvailability),
				_1: {ctor: '[]'}
			}
		}
	});
var _knowit$dashboard$Main$ClockMsg = function (a) {
	return {ctor: 'ClockMsg', _0: a};
};
var _knowit$dashboard$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$core$Platform_Sub$map,
				_knowit$dashboard$Main$ClockMsg,
				_knowit$dashboard$Clock$subscriptions(model.clock)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_knowit$dashboard$Main$RuterMonitorMsg,
					_knowit$dashboard$RuterMonitor$subscriptions(model.ruterMonitor)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Platform_Sub$map,
						_knowit$dashboard$Main$KantinemenyMsg,
						_knowit$dashboard$Kantinemeny$subscriptions(model.kantinemeny)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$core$Platform_Sub$map,
							_knowit$dashboard$Main$MeetingRoomsMsg,
							_knowit$dashboard$MeetingRooms$subscriptions(model.meetingRooms)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _knowit$dashboard$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'ClockMsg':
				return A3(
					_knowit$dashboard$Main$wrap,
					function (m) {
						return _elm_lang$core$Native_Utils.update(
							model,
							{clock: m});
					...
					_knowit$dashboard$Main$ClockMsg,
					A2(_knowit$dashboard$Clock$update, _p2._0, model.clock));
			case 'RuterMonitorMsg':
				return A3(
					_knowit$dashboard$Main$wrap,
					function (m) {
						return _elm_lang$core$Native_Utils.update(
					...
					_knowit$dashboard$Main$RuterMonitorMsg,
					A2(_knowit$dashboard$RuterMonitor$update, _p2._0, model.ruterMonitor));
			case 'KantinemenyMsg':
				return A3(
					_knowit$dashboard$Main$wrap,
					function (m) {
					...
					_knowit$dashboard$Main$KantinemenyMsg,
					A2(_knowit$dashboard$Kantinemeny$update, _p2._0, model.kantinemeny));
			default:
				return A3(
					_knowit$dashboard$Main$wrap,
					function (m) {
					...
					_knowit$dashboard$Main$MeetingRoomsMsg,
					A2(_knowit$dashboard$MeetingRooms$update, _p2._0, model.meetingRooms));
		}
	});
var _knowit$dashboard$Main$view = function (model) {
	return A2(
		_mdgriffith$style_elements$Element$layout,
		_knowit$dashboard$Main$stylesheet,
		A3(
			_mdgriffith$style_elements$Element$grid,
			_knowit$dashboard$Main$GridStyle,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Attributes$spacing(35),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			},
			{
				columns: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$percent(25),
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$percent(25),
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Attributes$percent(21),
								_1: {ctor: '[]'}
							}
						}
					}
				...
				rows: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$percent(5),
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$percent(1),
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Attributes$percent(40),
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Attributes$percent(40),
								_1: {ctor: '[]'}
					...
					_0: _mdgriffith$style_elements$Element$cell(
						{
							...
							content: A3(
								...
								{src: 'https://osloelmday.no/images/knowit.svg', caption: 'Knowit logo'})
						}),
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element$cell(
							{
								start: {ctor: '_Tuple2', _0: 3, _1: 0},
								width: 1,
								height: 1,
								content: A3(
									_mdgriffith$style_elements$Element$column,
									...
									{ctor: '[]'},
									{
										...
										_0: _mdgriffith$style_elements$Element$html(
											A2(
												...
												_knowit$dashboard$Main$ClockMsg,
												_knowit$dashboard$Clock$view(model.clock))),
										_1: {ctor: '[]'}
									})
							}),
						_1: {
								...
								_0: _mdgriffith$style_elements$Element$cell(
									{
										...
										content: A3(
											...
											{
												ctor: '::',
												_0: _mdgriffith$style_elements$Element_Attributes$padding(100),
												_1: {ctor: '[]'}
											},
											A3(
												_mdgriffith$style_elements$Element$image,
												_knowit$dashboard$Main$NoStyle,
												{ctor: '[]'},
												{src: 'http://sundtcommander.knowit.no/sundt.svg', caption: 'Møteromsoversikt'}))
									}),
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Element$cell(
										{
											start: {ctor: '_Tuple2', _0: 2, _1: 2},
											width: 2,
											height: 1,
											content: A3(
												_mdgriffith$style_elements$Element$column,
												...
												},
												{
													...
													_0: _mdgriffith$style_elements$Element$html(
														A2(
															_elm_lang$html$Html$map,
															_knowit$dashboard$Main$MeetingRoomsMsg,
															_knowit$dashboard$MeetingRooms$view(model.meetingRooms))),
													_1: {ctor: '[]'}
												})
										}),
									_1: {
													...
													{ctor: '[]'},
													{
														...
														_0: _mdgriffith$style_elements$Element$html(
															A2(
																_elm_lang$html$Html$map,
																_knowit$dashboard$Main$KantinemenyMsg,
																_knowit$dashboard$Kantinemeny$view(model.kantinemeny))),
														_1: {ctor: '[]'}
													})
											}),
										_1: {
														...
														{ctor: '[]'},
														{
															...
															_0: _mdgriffith$style_elements$Element$html(
																A2(
																	_elm_lang$html$Html$map,
																	_knowit$dashboard$Main$RuterMonitorMsg,
																	_knowit$dashboard$RuterMonitor$view(model.ruterMonitor))),
															_1: {ctor: '[]'}
														})
												}),
											_1: {ctor: '[]'}
...
var _knowit$dashboard$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _knowit$dashboard$Main$initModel, _1: _knowit$dashboard$Main$initialCmd},
		view: _knowit$dashboard$Main$view,
		update: _knowit$dashboard$Main$update,
		subscriptions: _knowit$dashboard$Main$subscriptions
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _knowit$dashboard$Main$main !== 'undefined') {
    _knowit$dashboard$Main$main(Elm['Main'], 'Main', undefined);
}
